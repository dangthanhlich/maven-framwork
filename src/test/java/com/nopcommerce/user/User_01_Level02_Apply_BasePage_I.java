...
public class User_01_Level02_Apply_BasePage_I {
	WebDriver driver;
	String emailAddress;
	...
	public void TC_04_Register_Existing_Email() {
		...
		driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("123456789");
		driver.findElement(By.cssSelector("button#register-button")).click();
		Assert.assertEquals(driver.findElement(By.cssSelector("div.message-error  ul li")).getText(), "The specified email already exists");
