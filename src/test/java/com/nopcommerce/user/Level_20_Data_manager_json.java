...
import com.data.nopcommerce.UserDataMapper;
...
public class Level_20_Data_manager_json extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		emailAddress = userData.getEmailAddress() + generateFakeNumber() + "@gmail.vn";
