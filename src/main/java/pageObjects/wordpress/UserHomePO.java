...
public class UserHomePO extends BasePage {
	...
	public boolean isPostInforDisplayedWithcurrentDay(String postTitle, String currentDay) {
		waitForElementVisible(driver, UserHomePageUI.POST_CURRET_DATE_TEXT_BY_POST_TITLE, postTitle, currentDay);
		return isElementDisplayed(driver, UserHomePageUI.POST_CURRET_DATE_TEXT_BY_POST_TITLE, postTitle, currentDay);
	}

	public UserPostDetailPO clickToPosrTitle(String postTitle) {
	...
	public boolean isPostInforUndisplayWithPostTitle(String editPostTitle) {
