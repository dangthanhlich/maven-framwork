...
public class UserPostDetailPO extends BasePage {
	...
	public boolean isPostInforDisplayedWithcurrentDay(String postTitle, String currentDay) {
		waitForElementVisible(driver, UserPostDetailPageUI.POST_CURRET_DATE_TEXT_BY_POST_TITLE, postTitle, currentDay);
		return isElementDisplayed(driver, UserPostDetailPageUI.POST_CURRET_DATE_TEXT_BY_POST_TITLE, postTitle,
				currentDay);
	}
